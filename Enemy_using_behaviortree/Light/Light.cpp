...
void CLight::light_Init(LPDIRECT3DDEVICE9 device)
{
	D3DMATERIAL9 mat;
	ZeroMemory(&mat, sizeof(mat));
	MaterialSetLight(mat, device);

	ZeroMemory(&this->settinglight_, sizeof(this->settinglight_));
	LightSet(settinglight_, device);
}

void CLight::MaterialSetLight(D3DMATERIAL9 mat, LPDIRECT3DDEVICE9 device)
{
	mat.Diffuse.r = 1.0f;
	mat.Diffuse.g = 1.0f;
	mat.Diffuse.b = 1.0f;
...
void CLight::LightSet(D3DLIGHT9 light ,LPDIRECT3DDEVICE9 device)
{
